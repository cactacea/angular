...
export class InvitationsService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public create(id: number, body: PostInvitationAccountsBody, observe?: 'body', reportProgress?: boolean): Observable<InvitationCreated>;
    public create(id: number, body: PostInvitationAccountsBody, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<InvitationCreated>>;
    public create(id: number, body: PostInvitationAccountsBody, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<InvitationCreated>>;
    public create(id: number, body: PostInvitationAccountsBody, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (id === null || id === undefined) {
