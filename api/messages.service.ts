...
export class MessagesService {
     ...
     */
    public _delete(body: DeleteMessagesBody, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public _delete(body: DeleteMessagesBody, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public _delete(body: DeleteMessagesBody, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public _delete(body: DeleteMessagesBody, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
